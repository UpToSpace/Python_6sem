...
mglearn.tools.plot_2d_separator(gbrt, X,ax=axes[0],fill=True,alpha=0.4,cm=mglearn.cm2)
...
axes[1].legend(["Тест класс 0", "Тест класс 1", "Обучение класс 0", "Обучение класс 1"],ncol=4,loc=(-1.1, 1.08),)
plt.show()
